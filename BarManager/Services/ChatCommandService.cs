    ...
    public unsafe bool Send(string command)
    {
        ...
        try
        {
            ...
            if (shell is null || uiModule is null)
            {
                ...
                DalamudServices.ChatGui.PrintError($"BarManager could not send party chat: {LastError}", "BarManager");
                return false;
            }
        ...
        catch (Exception ex)
        {
            ...
            DalamudServices.Log.Warning(ex, "BarManager failed to send chat command.");
            return false;
        }
    }
}
